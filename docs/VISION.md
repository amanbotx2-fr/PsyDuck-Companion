...
Every interaction should create delight without interrupting flow.

The companion should always feel alive.

Animations should feel intentional rather than decorative.

The user should smile without consciously noticing why.
...
- Comnyang
- Tamagotchi
- Pokémon GBA animations
- Clippy (without interruptions)
- Desktop Goose (without chaos)
- Raycast polish
